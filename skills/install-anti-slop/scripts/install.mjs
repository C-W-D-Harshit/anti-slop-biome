...
const target = resolve(process.cwd(), targetArgument ?? "tools/biome/anti-slop");
...
console.log(`Copied the anti-slop rules to ${target}`);
console.log(`Register each .grit file in the "plugins" array of biome.json.`);
